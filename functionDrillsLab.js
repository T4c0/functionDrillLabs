...
//CODE HERE
const faveColorFinder = (color1) => {
  return color1 === 'red' ? 'red is a great color'
    : color1 === 'green' ? 'green is a solid favorite color'
    : color1 === 'black' ? 'so trendy'
    : 'you need to evaluate your color choice'
}
var colorRating = faveColorFinder('pink')
